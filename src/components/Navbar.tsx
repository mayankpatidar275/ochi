...
function Navbar() {
  ...
  return (
    <header>
      <nav className="fixed z-[999] w-full px-8 py-8 font-NeueMontreal-Regular flex justify-between items-center">
        ...
        <div
          ...
          }  -translate-y-full opacity-0 text-black fixed bg-zinc-100 inset-0 px-8 py-8 pt-32 `}
        >
